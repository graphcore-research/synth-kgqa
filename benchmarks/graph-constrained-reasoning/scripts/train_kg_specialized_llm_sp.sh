...
DATASET_LIST="data/shortest_path_index_sp/synthetic_kgqa/train_def_scores.pkl"
# DATASET_LIST="data/shortest_path_index_sp/synthetic_kgqa/train_final_scores.pkl"
...
SAVE_PATH=save_models/def/GCR-$(basename "$MODEL_PATH")
