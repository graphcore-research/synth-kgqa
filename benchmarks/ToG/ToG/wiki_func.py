...
def entity_search(entity, relation, wiki_client, head):
    ...
    entities_set = wiki_client.knowledge_graph.neighbourhood_dict[entity][
    ...
    name_list = [wiki_client.get_node_label(item) for item in entities_set]

    return entities_set, name_list
...
def entity_prune(
    ...
    tops = [
        wiki_client.get_node_label(entity_id)
