...
class PromptBuilder(object):
    ...
    SAQ_RULE_INSTRUCTION = """Based on the reasoning paths, please answer the given question. Please keep the answer as simple as possible and return a single answer only."""
    ...
    def process_input(self, question_dict):
        ...
        if self.add_rule:
            ...
            # if len(lists_of_paths) > 300:
            #     lists_of_paths = lists_of_paths[:300]
